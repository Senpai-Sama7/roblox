...
* **[`src/ServerScriptService/GameServer.server.luau`](file:///home/donovan/Projects/platforms/Roblox/src/ServerScriptService/GameServer.server.luau)**: Core game loop executor, touch event handler, leaderboard updates, and security manager.
* **[`src/ServerScriptService/DataManager.luau`](file:///home/donovan/Projects/platforms/Roblox/src/ServerScriptService/DataManager.luau)**: Robust local persistence middleware with safe retries and atomic transaction handling.
* **[`src/StarterGui/ObbyHUD.client.luau`](file:///home/donovan/Projects/platforms/Roblox/src/StarterGui/ObbyHUD.client.luau)**: High-performance, lightweight UI controller driving the glassmorphic HUD.
* **[`src/StarterPlayer/StarterPlayerScripts/ObbyClient.client.luau`](file:///home/donovan/Projects/platforms/Roblox/src/StarterPlayerScripts/ObbyClient.client.luau)**: Localized cosmetic effects manager synthesizing beeps and rendering particle bursts.
# roblox
